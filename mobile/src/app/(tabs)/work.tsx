...
const styles = StyleSheet.create({
  ...
  currentTitle: { color: COLORS.textPrimary, fontSize: 18, fontWeight: "900", marginTop: 8 },
  ...
  jobTitle: { color: COLORS.textPrimary, fontSize: 16, fontWeight: "900", flex: 1 },
  jobStats: { flexDirection: "row", gap: 14, marginTop: 8 },
  salary: { color: COLORS.accentGold, fontWeight: "900" },
  duration: { color: COLORS.textSecondary, fontSize: 12, paddingTop: 2 },
});
